...
type Props = { title: string; categories: { key: string; label: string; items: string[] }[] };

const SkillsList = ({ title, categories }: Props) => {
        ...
        {categories.map(({ key, label, items }) => (
          <li key={key} className="w-full">
            ...
            >
              ...
              >
                <ul className="space-y-2 text-[var(--white-icon)] text-sm list-disc pl-5">
